...
<p style="font-size:14px; background-color:#FFFF00;"> The key takeaway from this book is the research based finding that those that give more actually succeed. However, you can't be a pushover. It's about giving, but also understanding that you too can ask for a favor and also need to learn the power of saying no. </p>
